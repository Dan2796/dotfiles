...
# set wd back one because nvim-R sets by the location of the file, which will
# be in src. Have a lock variable since don't want to repeat if it is rerun
if (!exists("have_set_wd")) {
 setwd("..")
